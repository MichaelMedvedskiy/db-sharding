package com.medvedskiy.repository.repositories.payment.db1;
...
/**
 * First Payment DB repository
 */
@Repository
public interface PaymentEntityDB1Repository extends JpaRepository<PaymentEntity, Long> {
