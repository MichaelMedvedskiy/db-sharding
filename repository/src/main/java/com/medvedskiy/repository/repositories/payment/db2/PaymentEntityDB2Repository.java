package com.medvedskiy.repository.repositories.payment.db2;
...
/**
 * Second Payment DB repository
 */
@Repository
public interface PaymentEntityDB2Repository extends JpaRepository<PaymentEntity, Long> {
